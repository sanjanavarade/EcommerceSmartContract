...
uint counter=1; Product[] public products;
...
function registerProduct(string memory _title,string memory _desc,uint _price) public isNotDestroyed{ 
    ...
    Product memory tempProduct; tempProduct.title =_title; 
...
// function destroy() public{ 
    ...
    // selfdestruct(manager); //Not the right way to destroy the contract
 // }
